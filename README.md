...
5. [User Authentication - AngularFireAuth](docs/5-user-authentication.md)
6. [Uploading Files - AngularFireStorage](docs/6-uploading-files.md)
7. [Using AngularFire2 with Ionic 2](docs/Auth-with-Ionic2.md)
8. [Using AngularFire2 with Ionic 3 and Angular 4](docs/Auth-with-Ionic3-Angular4.md)
